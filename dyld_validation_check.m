...
void init_bypassDyldLibValidation() {
    ...
    NSLog(@"[DyldLVBypass] init for TrollStore");
    
    // Check if running under TrollStore
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/containers/Bundle/Application/TrollStore.app"]) {
        NSLog(@"[DyldLVBypass] Not running under TrollStore, skipping");
        return;
    }
